 ...
 * Displays the app logo, name, and tagline with gradient background.
 */
export const runtime = 'edge';

export const alt = 'Aicona - Application Icon Generator';
export const size = {
  width: 1200,
  height: 630,
};
...
/**
 * OpenGraph image component for Twitter, Facebook, Discord, etc.
 * Renders a social media preview card with logo, title, and tagline.
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Generate and customize application icons with Lucide Icons
          </div>
        </div>
      </div>
    ),
